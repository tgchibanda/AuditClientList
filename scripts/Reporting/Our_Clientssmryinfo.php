...
//
// Table class for Our Clients
//
class crOur_Clients extends crTableBase {
	var $ShowGroupHeaderAsRow = FALSE;
	var $ShowCompactSummaryFooter = TRUE;
	var $company_name;
	var $relationship_owner;
	var $ref;
	var $city;
	...
	function __construct() {
		...
		// company_name
		$this->company_name = new crField('Our_Clients', 'Our Clients', 'x_company_name', 'company_name', '`company_name`', 201, EWR_DATATYPE_MEMO, -1);
		...
		// relationship_owner
		$this->relationship_owner = new crField('Our_Clients', 'Our Clients', 'x_relationship_owner', 'relationship_owner', '`relationship_owner`', 200, EWR_DATATYPE_STRING, -1);
		$this->relationship_owner->Sortable = TRUE; // Allow sort
		$this->relationship_owner->DateFilter = "";
		$this->relationship_owner->SqlSelect = "";
		$this->relationship_owner->SqlOrderBy = "";
		$this->fields['relationship_owner'] = &$this->relationship_owner;

		// ref
		$this->ref = new crField('Our_Clients', 'Our Clients', 'x_ref', 'ref', '`ref`', 200, EWR_DATATYPE_STRING, -1);
		...
		// city
		$this->city = new crField('Our_Clients', 'Our Clients', 'x_city', 'city', '`city`', 200, EWR_DATATYPE_STRING, -1);
	...
	function getSqlFrom() {
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`all clients`";
	}
