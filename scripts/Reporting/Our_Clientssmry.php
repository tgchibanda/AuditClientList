...
//		$item->Visible = TRUE;
	...
	function GetRow($opt) {
		...
		if (!$rs->EOF) {
			...
			$this->Val[3] = $this->ref->CurrentValue;
			$this->Val[4] = $this->city->CurrentValue;
		} else {
	...
	function RenderRow() {
		...
		if ($this->RowType == EWR_ROWTYPE_TOTAL && !($this->RowTotalType == EWR_ROWTOTAL_GROUP && $this->RowTotalSubType == EWR_ROWTOTAL_HEADER)) { // Summary row
			...
			$this->ref->CellAttrs["class"] = ($this->RecCount % 2 <> 1) ? "ewTableAltRow" : "ewTableRow";
		...
		if ($this->RowType == EWR_ROWTYPE_TOTAL) { // Summary row
			...
			// ref
			$CurrentValue = $this->ref->CurrentValue;
			$ViewValue = &$this->ref->ViewValue;
			$ViewAttrs = &$this->ref->ViewAttrs;
			$CellAttrs = &$this->ref->CellAttrs;
			$HrefValue = &$this->ref->HrefValue;
			$LinkAttrs = &$this->ref->LinkAttrs;
			$this->Cell_Rendered($this->ref, $CurrentValue, $ViewValue, $ViewAttrs, $CellAttrs, $HrefValue, $LinkAttrs);
	...
	function SetupFieldCount() {
		...
		if ($this->ref->Visible) $this->DtlColumnCount += 1;
...
<?php } ?>
<?php } ?>
<?php if ($Page->ref->Visible) { ?>
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="ref"><div class="Our_Clients_ref"><span class="ewTableHeaderCaption"><?php echo $Page->ref->FldCaption() ?></span></div></td>
<?php } else { ?>
	<td data-field="ref">
<?php if ($Page->SortUrl($Page->ref) == "") { ?>
		<div class="ewTableHeaderBtn Our_Clients_ref">
			<span class="ewTableHeaderCaption"><?php echo $Page->ref->FldCaption() ?></span>
		</div>
<?php } else { ?>
		<div class="ewTableHeaderBtn ewPointer Our_Clients_ref" onclick="ewr_Sort(event,'<?php echo $Page->SortUrl($Page->ref) ?>',0);">
			<span class="ewTableHeaderCaption"><?php echo $Page->ref->FldCaption() ?></span>
			<span class="ewTableHeaderSort"><?php if ($Page->ref->getSort() == "ASC") { ?><span class="caret ewSortUp"></span><?php } elseif ($Page->ref->getSort() == "DESC") { ?><span class="caret"></span><?php } ?></span>
		</div>
<?php } ?>
	</td>
<?php } ?>
...
<?php } ?>
<?php if ($Page->ref->Visible) { ?>
		<td data-field="ref"<?php echo $Page->ref->CellAttributes() ?>>
<span<?php echo $Page->ref->ViewAttributes() ?>><?php echo $Page->ref->ListViewValue() ?></span></td>
<?php } ?>
<?php if ($Page->city->Visible) { ?>
