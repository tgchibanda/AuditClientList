...
//
// Table class for IRBA 2
//
class crIRBA_2 extends crTableBase {
	...
	function __construct() {
		...
		$this->TableVar = 'IRBA_2';
		$this->TableName = 'IRBA 2';
		...
		// Client_Name
		$this->Client_Name = new crField('IRBA_2', 'IRBA 2', 'x_Client_Name', 'Client_Name', '`Client_Name`', 201, EWR_DATATYPE_MEMO, -1);
		...
		// Group_Structure
		$this->Group_Structure = new crField('IRBA_2', 'IRBA 2', 'x_Group_Structure', 'Group_Structure', '`Group_Structure`', 200, EWR_DATATYPE_STRING, -1);
		...
		// Client_CIPC
		$this->Client_CIPC = new crField('IRBA_2', 'IRBA 2', 'x_Client_CIPC', 'Client_CIPC', '`Client_CIPC`', 200, EWR_DATATYPE_STRING, -1);
		$this->Client_CIPC->Sortable = TRUE; // Allow sort
		$this->Client_CIPC->DateFilter = "";
		$this->Client_CIPC->SqlSelect = "SELECT DISTINCT `Client_CIPC`, `Client_CIPC` AS `DispFld` FROM " . $this->getSqlFrom();
		$this->Client_CIPC->SqlOrderBy = "`Client_CIPC`";
		$this->fields['Client_CIPC'] = &$this->Client_CIPC;

		// Companies_Act
		$this->Companies_Act = new crField('IRBA_2', 'IRBA 2', 'x_Companies_Act', 'Companies_Act', '`Companies_Act`', 200, EWR_DATATYPE_STRING, -1);
		...
		// IRBA_Code
		$this->IRBA_Code = new crField('IRBA_2', 'IRBA 2', 'x_IRBA_Code', 'IRBA_Code', '`IRBA_Code`', 200, EWR_DATATYPE_STRING, -1);
		...
		// ISQC_1
		$this->ISQC_1 = new crField('IRBA_2', 'IRBA 2', 'x_ISQC_1', 'ISQC_1', '`ISQC_1`', 200, EWR_DATATYPE_STRING, -1);
		...
		// ISQC_2
		$this->ISQC_2 = new crField('IRBA_2', 'IRBA 2', 'x_ISQC_2', 'ISQC_2', '`ISQC_2`', 200, EWR_DATATYPE_STRING, -1);
		...
		// Assurance_Work
		$this->Assurance_Work = new crField('IRBA_2', 'IRBA 2', 'x_Assurance_Work', 'Assurance_Work', '`Assurance_Work`', 200, EWR_DATATYPE_STRING, -1);
		...
		// Amount_Billed
		$this->Amount_Billed = new crField('IRBA_2', 'IRBA 2', 'x_Amount_Billed', 'Amount_Billed', '`Amount_Billed`', 200, EWR_DATATYPE_STRING, -1);
		...
		// JSE_Listed
		$this->JSE_Listed = new crField('IRBA_2', 'IRBA 2', 'x_JSE_Listed', 'JSE_Listed', '`JSE_Listed`', 200, EWR_DATATYPE_STRING, -1);
		...
		// Industry
		$this->Industry = new crField('IRBA_2', 'IRBA 2', 'x_Industry', 'Industry', '`Industry`', 200, EWR_DATATYPE_STRING, -1);
		...
		// Period_end_of_AFS
		$this->Period_end_of_AFS = new crField('IRBA_2', 'IRBA 2', 'x_Period_end_of_AFS', 'Period_end_of_AFS', '`Period_end_of_AFS`', 200, EWR_DATATYPE_STRING, -1);
		...
		$this->Date_Opinion_was_signed = new crField('IRBA_2', 'IRBA 2', 'x_Date_Opinion_was_signed', 'Date_Opinion_was_signed', '`Date_Opinion_was_signed`', 200, EWR_DATATYPE_STRING, -1);
		...
		// Partner
		$this->Partner = new crField('IRBA_2', 'IRBA 2', 'x_Partner', 'Partner', '`Partner`', 200, EWR_DATATYPE_STRING, -1);
		$this->Partner->Sortable = TRUE; // Allow sort
		$this->Partner->DateFilter = "";
		$this->Partner->SqlSelect = "SELECT DISTINCT `Partner`, `Partner` AS `DispFld` FROM " . $this->getSqlFrom();
		$this->Partner->SqlOrderBy = "`Partner`";
		$this->fields['Partner'] = &$this->Partner;

		// Next_IRBA
		$this->Next_IRBA = new crField('IRBA_2', 'IRBA 2', 'x_Next_IRBA', 'Next_IRBA', '`Next_IRBA`', 200, EWR_DATATYPE_STRING, -1);
		...
		$this->Accounting_Framework = new crField('IRBA_2', 'IRBA 2', 'x_Accounting_Framework', 'Accounting_Framework', '`Accounting_Framework`', 200, EWR_DATATYPE_STRING, -1);
		...
		// Client_Turnover
		$this->Client_Turnover = new crField('IRBA_2', 'IRBA 2', 'x_Client_Turnover', 'Client_Turnover', '`Client_Turnover`', 200, EWR_DATATYPE_STRING, -1);
	...
	function getSqlFrom() {
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`assurance`";
	}
	...
	function SetupLookupFilters($fld) {
		...
		switch ($fld->FldVar) {
		case "x_Client_CIPC":
			$fld->LookupFilters = array("d" => "DB", "f0" => '`Client_CIPC` = {filter_value}', "t0" => "200", "fn0" => "", "dlm" => ewr_Encrypt($fld->FldDelimiter), "af" => json_encode($fld->AdvancedFilters));
		$sWhereWrk = "";
		$fld->LookupFilters += array(
			"select" => "SELECT DISTINCT `Client_CIPC`, `Client_CIPC` AS `DispFld`, '' AS `DispFld2`, '' AS `DispFld3`, '' AS `DispFld4` FROM `assurance`",
			"where" => $sWhereWrk,
			"orderby" => "`Client_CIPC` ASC"
		);
		...
		$fld->LookupFilters["s"] = ewr_BuildReportSql($fld->LookupFilters["select"], $fld->LookupFilters["where"], "", "", $fld->LookupFilters["orderby"], "", "");
			break;
		case "x_Partner":
			$fld->LookupFilters = array("d" => "DB", "f0" => '`Partner` = {filter_value}', "t0" => "200", "fn0" => "", "dlm" => ewr_Encrypt($fld->FldDelimiter), "af" => json_encode($fld->AdvancedFilters));
		$sWhereWrk = "";
		$fld->LookupFilters += array(
			"select" => "SELECT DISTINCT `Partner`, `Partner` AS `DispFld`, '' AS `DispFld2`, '' AS `DispFld3`, '' AS `DispFld4` FROM `assurance`",
			"where" => $sWhereWrk,
			"orderby" => "`Partner` ASC"
		);
		$this->Lookup_Selecting($fld, $fld->LookupFilters["where"]); // Call Lookup selecting
