...
//		$item->Visible = FALSE;
	...
	function GetRow($opt) {
		...
		if (!$rs->EOF) {
			...
			$this->Val[2] = $this->Audit_Fee->CurrentValue;
			$this->Val[3] = $this->Period_end_of_AFS->CurrentValue;
			$this->Val[4] = $this->Date_Opinion_was_signed->CurrentValue;
			$this->Val[5] = $this->PI_Score->CurrentValue;
			$this->Val[6] = $this->Partner->CurrentValue;
			$this->Val[7] = $this->Risk->CurrentValue;
			$this->Val[8] = $this->City->CurrentValue;
		} else {
			$this->No->setDbValue("");
...
<?php if ($Page->Export <> "" || $Page->DrillDown) { ?>
	<td data-field="Client_Name"><div class="IRBA_Report_Client_Name"><span class="ewTableHeaderCaption"><?php echo $Page->Client_Name->FldCaption() ?></span></div></td>
<?php } else { ?>
