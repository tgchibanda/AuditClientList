...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "nkonki", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", '9sCYDZZddFFqQPi7', TRUE); // Random key for encryption
