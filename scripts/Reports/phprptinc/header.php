...
<?php } ?>
<link rel="shortcut icon" type="image/x-icon" href="<?php echo $EWR_RELATIVE_PATH ?>nkonki_intranet_icon.ico"><link rel="icon" type="image/x-icon" href="<?php echo $EWR_RELATIVE_PATH ?>nkonki_intranet_icon.ico">
...
<div class="wrapper ewLayout">
	...
	<header class="main-header">
		<div class="logo">
			...
			<span class="logo-lg">Reports</span>
		</div>
		<!-- Header Navbar -->
